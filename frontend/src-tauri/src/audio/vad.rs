...
impl ContinuousVadProcessor {
    ...
    pub fn new_with_thresholds(
        ...
        Ok(Self {
            ...
            pre_speech_history: VecDeque::with_capacity(48_000),
            in_speech: false,
            processed_samples: 0,
    ...
    fn process_chunk(&mut self, chunk: &[f32]) -> Result<()> {
        ...
        for transition in transitions {
            match transition {
                VadTransition::SpeechStart { timestamp_ms } => {
                    ...
                    // Seed the live Whisper window with up to three seconds of
        ...
        if self.in_speech {
            ...
            const PRE_SPEECH_HISTORY_SAMPLES: usize = 48_000; // 3.0s at 16 kHz
